        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <ul className="space-y-6 text-lg text-foreground/90">
            <li className="flex items-start gap-4">
              ...
              <span>Roorkee lies on the Amritsar–Howrah main line of the Northern Railway and is well-connected by rail and road to major cities, including New Delhi, Dehradun, Haridwar, Rishikesh, Chandigarh, and Agra.</span>
            </li>
            <li className="flex items-start gap-4">
