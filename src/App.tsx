...
import { InternationalSpeakers } from "./pages/InternationalSpeakers";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path={rootUrl ? rootUrl + "/international-speakers" : "/international-speakers"} element={<InternationalSpeakers />} />
