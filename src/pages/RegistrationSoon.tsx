...
export default function RegistrationSoon() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-500 via-purple-500 to-pink-400 animate-gradient-motion">
      ...
      {/* Action Button */}
      <Button size="lg" className="bg-white text-purple-600 font-bold shadow-lg hover:bg-purple-100 transition-all animate-fade-in-delay" onClick={() => navigate(`${import.meta.env.VITE_ROOT_URL || ""}/`)}>Go Back to Home</Button>
    </div>
  );
}
