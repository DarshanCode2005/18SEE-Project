...
export const ManuscriptInstructions = () => {
  ...
  // Custom footer (same style as CMT Instructions page)
  const PageFooter = () => {
    const rootUrl = import.meta.env.VITE_ROOT_URL || "";
    const quickLinks = [
      { name: "Home", href: "#home" },
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <p>
            Information on the title and contributing author(s) of your abstract should be visible. You may
            enter the (accepted) abstract in the space provided. Next, select one{" "}
            <span className="text-black font-bold">Primary Subject Area</span> (mandatory) and up to three{" "}
            <span className="text-black font-bold">Secondary Subject Areas</span> (optional) that best describe
            your study. Finally, upload the{" "}
            <span className="text-black font-bold">PDF file</span> containing your full-length manuscript. If
            you are not the corresponding author, please also enter the particulars of the corresponding author
            in the space provided.
          </p>
          <p>
            Click the <span className="text-teal-600 font-medium">Save Changes</span> button once you
    ...
    },
    {
      ...
      content: (
        <>
          ...
          Click <span className="text-teal-600 font-medium">Done</span> at the bottom of the page and you
          shall subsequently see a summary of your submission.
        </>
      ),
      image: null
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-card border rounded-lg p-6 mb-8">
          ...
          <p className="font-semibold mb-4 text-primary text-lg">
            Please prepare your full-length manuscript of 8-10 pages using the prescribed template. This is to
            be uploaded as a single PDF file through the Microsoft CMT portal of 18SEE–2026. Follow the simple
            steps given below to complete your submission.
          </p>
          <div className="mt-4 flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" asChild className="border-2 border-gray-600 hover:border-gray-700">
              <a href="https://drive.google.com/drive/folders/1aVVO0jjXvpqjRjGyNxKDyYkGNZQLB7zw" target="_blank" rel="noopener noreferrer">
